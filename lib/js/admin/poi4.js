...
var arrayComponentsToDisable = arrayComponentsToDisableRole4Moderateur;
...
var POIsColumnModel = new Ext.grid.ColumnModel(
    ...
    }, printPOIButton,chkColumn_moderationPOI, photoPOI, moderatePOIButton,{
...
function saveThePOI(oGrid_event) {
    ...
    Ext.Ajax.request({
        ...
        params: {
            ...
            display_poi: oGrid_event.record.data.display_poi,
            fix_poi: oGrid_event.record.data.fix_poi,
            moderation_poi: oGrid_event.record.data.moderation_poi
        },
...
var arrayItemsMenuBottomAdminMap = [searchObservationField, checkBoxdisplayLayerLimitesGeographiquesCommunes,' ',checkBoxDisplaylayerLimitesGeographiquesPoles, '->',comboALL];
	                        				...
	                        				if(PhotoPOIModifSuppForm.getForm().isValid()) {
	                        					PhotoPOIModifSuppForm.getForm().submit({
	                        						...
	                        						success: function(PhotoPOIModifSuppForm, o) {
	                        							...
	                        							if (POIListingEditorGrid.selModel != null){
	                        								//POIListingEditorGrid.selModel.clearSelections();
	                        							}
	                        							if ((o.result.imageName != null) && (o.result.imageName != '')) {
			var tof = o.result.imageName;
			PhotoPOIField.setValue(tof);
	                        						...
	                        						Ext.Ajax.request({
	                        							...
	                        							success: function(response) {            
	                        								...
	                        								switch (result) {
	                        									case 1:
	                        										POIsDataStore.reload();
	                        										if (POIListingEditorGrid != null){
	                        											//POIListingEditorGrid.selModel.clearSelections();
	                        										}
	                        										PhotoPOIField.setValue("");
	                        										Ext.getCmp('observationImagePanel').update('Aucune image associée');
	                        										break;
	                        									default:
